...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание =
		НСтр("ru = 'Позволяет выполнять мониторинг активности пользователей в программе (насколько интенсивно и с какими объектами работают пользователи).'");
	...
	КонецЕсли;
	НастройкиВарианта.Описание =
		НСтр("ru = 'Позволяет выполнять мониторинг активности подразделений в программе (насколько интенсивно и с какими объектами работают пользователи подразделений).'");
	...
	КонецЕсли;
	НастройкиВарианта.Описание =
		НСтр("ru = 'Подробная информация о том, с какими объектами работал пользователь в программе.'");
