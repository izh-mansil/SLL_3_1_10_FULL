...
Процедура ПриЗаполненииРеквизитовОрганизации(Организация, Реквизиты, СтандартнаяОбработка) Экспорт
	...
	_ДемоСтандартныеПодсистемы.ПриЗаполненииРеквизитовОрганизацииВМЧД(Организация, Реквизиты, СтандартнаяОбработка);
	// _Демо конец примера
...
Процедура ПриЗаполненииРеквизитовФизическогоЛица(ФизическоеЛицо, Реквизиты) Экспорт
	...
	// _Демо начало примера
	_ДемоСтандартныеПодсистемы.ПриЗаполненииРеквизитовФизическогоЛицаВМЧД(ФизическоеЛицо, Реквизиты);
	// _Демо конец примера
...
Процедура ПриЗаполненииРеквизитовКонтрагента(Контрагент, Реквизиты) Экспорт
	...
	// _Демо начало примера
	_ДемоСтандартныеПодсистемы.ПриЗаполненииРеквизитовКонтрагентаВМЧД(Контрагент, Реквизиты);
	// _Демо конец примера
...
Процедура ПриПроверкеДоверенностиПодписи(ДанныеДоверенности, Сертификат, ПротоколПроверки) Экспорт
	...
	// _Демо начало примера
	_ДемоСтандартныеПодсистемы.ПриПроверкеДоверенностиПодписи(ДанныеДоверенности, Сертификат, ПротоколПроверки);
	// _Демо конец примера
...
Процедура ПриПолученииСтатусаРегистрации(Доверенность, РегистрацияВРеестре) Экспорт
	...
	// _Демо начало примера
	_ДемоСтандартныеПодсистемы.ПриПолученииСтатусаРегистрацииМЧД(Доверенность, РегистрацияВРеестре);
	// _Демо конец примера
...
Процедура ПриРегистрацииДоверенности(Доверенность) Экспорт
	...
	// _Демо начало примера
	_ДемоСтандартныеПодсистемы.ПриРегистрацииДоверенности(Доверенность);
	// _Демо конец примера
...
Процедура ПриОпределенииНастроек(Настройки) Экспорт
	...
	// _Демо начало примера
	_ДемоСтандартныеПодсистемы.ПриОпределенииНастроекМЧД(Настройки);
	// _Демо конец примера
...
Процедура ПриПолученииСтатусов(Доверенности, Статусы) Экспорт
	...
	// _Демо начало примера
	_ДемоСтандартныеПодсистемы.ПриПолученииСтатусов(Доверенности, Статусы);
	// _Демо конец примера
