...
Функция ТекстОбращенияВТехническуюПоддержку() Экспорт
	Возврат НСтр("ru = '<Опишите возникшую проблему, приложите скриншоты ошибки и версии программы для работы с электронной подписью (криптопровайдера).>'");
КонецФункции

Функция ТекстОбращенияВТехническуюПоддержкуПриПроверкеСертификата() Экспорт
	Возврат НСтр("ru = '<Опишите возникшую проблему, приложите скриншоты ошибки и версии программы для работы с электронной подписью (криптопровайдера), а также
