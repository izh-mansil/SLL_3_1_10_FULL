...
Процедура ОткрытьФормуЗавершенияРаботыПользователей()
	...
	Если ОбщегоНазначенияКлиент.ПодсистемаСуществует("СтандартныеПодсистемы.ЗавершениеРаботыПользователей") Тогда
		...
		ПараметрыФормы.ТекстСообщенияОбОшибке = НСтр("ru = 'Невозможно выполнить удаление помеченных объектов, т.к. в программе работают другие пользователи:'");
		...
		ПараметрыФормы.СообщениеПриВходеВПриложение = НСтр("ru = 'Программа заблокирована для удаления помеченных объектов.'");
