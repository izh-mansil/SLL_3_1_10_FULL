...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		РегистрироватьДоступКДанным = МодульКонтрольРаботыПользователейСлужебный.ВключенаРегистрацияДоступаКДанным();
	КонецЕсли;
...
Процедура РегистрироватьДоступКДаннымПриИзмененииНаСервере(Знач РегистрироватьДоступКДанным)
	...
	МодульКонтрольРаботыПользователейСлужебный = ОбщегоНазначения.ОбщийМодуль("КонтрольРаботыПользователейСлужебный");
	МодульКонтрольРаботыПользователейСлужебный.УстановитьРегистрациюДоступаКДанным(РегистрироватьДоступКДанным);
