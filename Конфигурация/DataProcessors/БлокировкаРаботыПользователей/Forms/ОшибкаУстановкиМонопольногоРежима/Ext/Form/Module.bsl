...
Процедура УстановитьБлокировкуФайловойБазы()
	...
	Объект.СообщениеДляПользователей = ?(ЗначениеЗаполнено(Параметры.СообщениеПриВходеВПриложение), Параметры.СообщениеПриВходеВПриложение, НСтр("ru = 'Программа заблокирована для обновления на новую версию.'"));
