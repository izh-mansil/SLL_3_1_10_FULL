...
Процедура ОбновитьПредставлениеАдреса()
	...
	ПредставлениеАдреса = РаботаСАдресамиКлиентСервер.ПредставлениеАдреса(НаселенныйПунктДетально, ВидКонтактнойИнформации.ВключатьСтрануВПредставление, ,Истина);
	НаселенныйПунктДетально.Value = ПредставлениеАдреса;
