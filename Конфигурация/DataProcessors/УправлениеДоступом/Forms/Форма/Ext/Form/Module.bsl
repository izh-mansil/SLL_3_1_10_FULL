...
#Если ВебКлиент Или МобильныйКлиент Тогда
		ПоказатьПредупреждение(, НСтр("ru = 'Инструмент ""Управление доступом"" недоступен в веб-клиенте и мобильном клиенте, используйте тонкий клиент.'"));
		Отказ = Истина;
		Возврат;
#КонецЕсли
...
Процедура ДобавитьОписаниеРолейИВидовДоступа(Строки, Профиль)
	...
	ИдентификаторыРолей = Профиль.Роли.Выгрузить().ВыгрузитьКолонку("Роль");
	ИменаРолей = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(ИдентификаторыРолей, "Имя");
	Для Каждого ОписаниеРоли Из Профиль.Роли Цикл
		ОписаниеРолей.Добавить(ИменаРолей.Получить(ОписаниеРоли.Роль));
	КонецЦикла;
...
#Если МобильныйКлиент Тогда
	ПоказатьПредупреждение(, НСтр("ru = 'Инструмент ""Управление доступом""  в веб-клиенте и мобильном клиенте, используйте тонкий клиент.'"));
	Возврат;
#Иначе
